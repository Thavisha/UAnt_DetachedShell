...
Code modified from Observed Radial profile plotting
...
fig.text(0.06, 0.5,"Normalized Surface Brightness", va='center', rotation='vertical')
...
ax1.errorbar(x_InnerShell_70[radial_limit_Mod_70], stellar_InnerShell_70[radial_limit_Mod_70]/np.max(stellar_InnerShell_70[radial_limit_Mod_70]), fmt='-', color='green', markersize=8, capsize=7, label='70$\\mu m$ Model_ss1') 
ax1.errorbar(x_InnerShell_70[radial_limit_Mod_70], stellar_ShellTwo_70[radial_limit_Mod_70]/np.max(stellar_ShellTwo_70[radial_limit_Mod_70]), fmt='-', color='violet', markersize=8, capsize=7, label='70$\\mu m$ Model_ss2') 
ax1.errorbar(x_InnerShell_70[radial_limit_Mod_70], stellar_ShellThree_70[radial_limit_Mod_70]/np.max(stellar_ShellThree_70[radial_limit_Mod_70]), fmt='-', color='springgreen', markersize=8, capsize=7, label='70$\\mu m$ Model_ss3') 
ax1.errorbar(x_InnerShell_70[radial_limit_Mod_70], stellar_OuterShell_M2010_70[radial_limit_Mod_70]/np.max(stellar_OuterShell_M2010_70[radial_limit_Mod_70]), fmt='-', color='red', markersize=8, capsize=7, label='70$\\mu m$ Model_ss4_M2010')
ax1.errorbar(x_InnerShell_70[radial_limit_Mod_70], stellar_OuterShell_K2010_70[radial_limit_Mod_70]/np.max(stellar_OuterShell_K2010_70[radial_limit_Mod_70]), fmt='-', color='gold', markersize=8, capsize=7, label='70$\\mu m$ Model_ss4_K2010')
ax1.errorbar(x_InnerShell_70[radial_limit_Mod_70], stellar_FourShells_Uneven_70[radial_limit_Mod_70]/np.max(stellar_FourShells_Uneven_70[radial_limit_Mod_70]), fmt='-', color='blue', markersize=8, capsize=7, label='70$\\mu m$ Model_FourShells')
#ax1.errorbar(x_InnerShell_70[radial_limit_Mod_70], stellar_FourShells_Even_70[radial_limit_Mod_70]/np.max(stellar_FourShells_Even_70[radial_limit_Mod_70]), fmt='-', color='purple', markersize=8, capsize=7, label='70$\\mu m$ Model_FourShells_EvenMass')
...
############################  Plotting 160micron Radial + PSF Profile  #########################################3
...
ax2.errorbar(x_InnerShell_160[radial_limit_Mod_160], stellar_InnerShell_160[radial_limit_Mod_160]/np.max(stellar_InnerShell_160[radial_limit_Mod_160]), fmt='-', color='green', markersize=8, capsize=7, label='160$\\mu m$ Model_ss1') 
ax2.errorbar(x_InnerShell_160[radial_limit_Mod_160], stellar_ShellTwo_160[radial_limit_Mod_160]/np.max(stellar_ShellTwo_160[radial_limit_Mod_160]), fmt='-', color='violet', markersize=8, capsize=7, label='160$\\mu m$ Model_ss2') 
ax2.errorbar(x_InnerShell_160[radial_limit_Mod_160], stellar_ShellThree_160[radial_limit_Mod_160]/np.max(stellar_ShellThree_160[radial_limit_Mod_160]), fmt='-', color='springgreen', markersize=8, capsize=7, label='160$\\mu m$ Model_ss3') 
ax2.errorbar(x_InnerShell_160[radial_limit_Mod_160], stellar_OuterShell_M2010_160[radial_limit_Mod_160]/np.max(stellar_OuterShell_M2010_160[radial_limit_Mod_160]), fmt='-', color='red', markersize=8, capsize=7, label='160$\\mu m$ Model_ss4_M2010')
ax2.errorbar(x_InnerShell_160[radial_limit_Mod_160], stellar_OuterShell_K2010_160[radial_limit_Mod_160]/np.max(stellar_OuterShell_K2010_160[radial_limit_Mod_160]), fmt='-', color='gold', markersize=8, capsize=7, label='160$\\mu m$ Model_ss4_K2010')
ax2.errorbar(x_InnerShell_160[radial_limit_Mod_160], stellar_FourShells_Uneven_160[radial_limit_Mod_160]/np.max(stellar_FourShells_Uneven_160[radial_limit_Mod_160]), fmt='-', color='blue', markersize=8, capsize=7, label='160$\\mu m$ Model_FourShells')
#ax2.errorbar(x_InnerShell_160[radial_limit_Mod_160], stellar_FourShells_Even_160[radial_limit_Mod_160]/np.max(stellar_FourShells_Even_160[radial_limit_Mod_160]), fmt='-', color='purple', markersize=8, capsize=7, label='160$\\mu m$ Model_FourShells_EvenMass')
...
textstr = 'Herschel/PACS 160 $\mu$m'
props = dict(boxstyle='round', facecolor='white', alpha=0.5)
...
#################  Plotting 450micron Radial + PSF Profile ####################################3333
...
ax3.errorbar(x_InnerShell_450[radial_limit_Mod_450], stellar_InnerShell_450[radial_limit_Mod_450]/np.max(stellar_InnerShell_450[radial_limit_Mod_450]), fmt='-', color='green', markersize=8, capsize=7, label='450$\\mu m$ Mss1') 
ax3.errorbar(x_InnerShell_450[radial_limit_Mod_450], stellar_ShellTwo_450[radial_limit_Mod_450]/np.max(stellar_ShellTwo_450[radial_limit_Mod_450]), fmt='-', color='violet', markersize=8, capsize=7, label='450$\\mu m$ Mss2') 
ax3.errorbar(x_InnerShell_450[radial_limit_Mod_450], stellar_ShellThree_450[radial_limit_Mod_450]/np.max(stellar_ShellThree_450[radial_limit_Mod_450]), fmt='-', color='springgreen', markersize=8, capsize=7, label='450$\\mu m$ Mss3') 
ax3.errorbar(x_InnerShell_450[radial_limit_Mod_450], stellar_OuterShell_M2010_450[radial_limit_Mod_450]/np.max(stellar_OuterShell_M2010_450[radial_limit_Mod_450]), fmt='-', color='red', markersize=8, capsize=7, label='450$\\mu m$ Mss4-M2010')
ax3.errorbar(x_InnerShell_450[radial_limit_Mod_450], stellar_OuterShell_K2010_450[radial_limit_Mod_450]/np.max(stellar_OuterShell_K2010_450[radial_limit_Mod_450]), fmt='-', color='gold', markersize=8, capsize=7, label='450$\\mu m$ Mss4-K2010')
ax3.errorbar(x_InnerShell_450[radial_limit_Mod_450], stellar_FourShells_Uneven_450[radial_limit_Mod_450]/np.max(stellar_FourShells_Uneven_450[radial_limit_Mod_450]), fmt='-', color='blue', markersize=8, capsize=7, label='450$\\mu m$ Mfourshells')
#ax3.errorbar(x_InnerShell_450[radial_limit_Mod_450], stellar_FourShells_Even_450[radial_limit_Mod_450]/np.max(stellar_FourShells_Even_450[radial_limit_Mod_450]), fmt='-', color='purple', markersize=8, capsize=7, label='450$\\mu m$ Model_FourShells_EvenMass')
...
ax4.errorbar(x_InnerShell_850[radial_limit_Mod_850], stellar_InnerShell_850[radial_limit_Mod_850]/np.max(stellar_InnerShell_850[radial_limit_Mod_850]), fmt='-', color='green', markersize=8, capsize=7, label='850$\\mu m$ Model_ss1') 
ax4.errorbar(x_InnerShell_850[radial_limit_Mod_850], stellar_ShellTwo_850[radial_limit_Mod_850]/np.max(stellar_ShellTwo_850[radial_limit_Mod_850]), fmt='-', color='violet', markersize=8, capsize=7, label='850$\\mu m$ Model_ss2') 
ax4.errorbar(x_InnerShell_850[radial_limit_Mod_850], stellar_ShellThree_850[radial_limit_Mod_850]/np.max(stellar_ShellThree_850[radial_limit_Mod_850]), fmt='-', color='springgreen', markersize=8, capsize=7, label='850$\\mu m$ Model_ss3') 
ax4.errorbar(x_InnerShell_850[radial_limit_Mod_850], stellar_OuterShell_M2010_850[radial_limit_Mod_850]/np.max(stellar_OuterShell_M2010_850[radial_limit_Mod_850]), fmt='-', color='red', markersize=8, capsize=7, label='850$\\mu m$ Model_ss4_M2010')
ax4.errorbar(x_InnerShell_850[radial_limit_Mod_850], stellar_OuterShell_K2010_850[radial_limit_Mod_850]/np.max(stellar_OuterShell_K2010_850[radial_limit_Mod_850]), fmt='-', color='gold', markersize=8, capsize=7, label='850$\\mu m$ Model_ss4_K2010')
ax4.errorbar(x_InnerShell_850[radial_limit_Mod_850], stellar_FourShells_Uneven_850[radial_limit_Mod_850]/np.max(stellar_FourShells_Uneven_850[radial_limit_Mod_850]), fmt='-', color='blue', markersize=8, capsize=7, label='850$\\mu m$ Model_FourShells')
#ax4.errorbar(x_InnerShell_850[radial_limit_Mod_850], stellar_FourShells_Even_850[radial_limit_Mod_850]/np.max(stellar_FourShells_Even_850[radial_limit_Mod_850]), fmt='-', color='purple', markersize=8, capsize=7, label='850$\\mu m$ Model_FourShells_EvenMass')
