...
def FourShells_EvenMass(dust_file_name, fnu, nu, stellar_luminoisity, stellar_temperature,  stellar_radius, total_shell_mass, uant_distance, expansion_velocity, MaxCSE_outer_rad, Photon_Number, CPU_Number):
	...
	envelope_shell3.rmin = (41.5 * uant_distance) * au      #Mearcker+2010  and G2001&2003         
	envelope_shell3.rmax = (44.5 * uant_distance) * au     #Mearcker+2010  and G2001&2003    
	...
	# Write out file
	Input_FourShells_EvenMass = 'Model_FourShells_EvenMass.rtin' #File which saves all the input above so that fortran can run internally for RT modelling
	Output_FourShells_EvenMass = 'Model_FourShells_EvenMass.rtout'
	
	model.write(Input_FourShells_EvenMass)
	model.run(Output_FourShells_EvenMass, mpi=True, n_processes=CPU_Number)

	return Input_FourShells_EvenMass, Output_FourShells_EvenMass
