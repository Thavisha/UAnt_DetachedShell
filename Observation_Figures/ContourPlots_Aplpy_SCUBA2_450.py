...
wavelength = 450 
Source = Table.read('UAnt_ContourPlot_Info_450.csv', format='ascii.csv')
fig = aplpy.FITSFigure('uant_450.fits')
...
x_corner_pix = 205  #Units in pixels 
y_corner_pix = 180 #Units in pixels 
