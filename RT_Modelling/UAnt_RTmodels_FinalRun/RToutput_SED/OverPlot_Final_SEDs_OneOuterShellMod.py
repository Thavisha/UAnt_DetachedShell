...
ax.errorbar(obs_wavelength[a], outer_M2010_flux[a], fmt='-', color='red', markersize=6, capsize=2, label='Model_Outer') #Outer Shell (M2010) + Cont Emission - Shell size from Maercker+2010
...
ax.errorbar(obs_wavelength[a], cont_only_flux[a], fmt='-', color='violet', markersize=6, capsize=2, label='Model_NoShells') #Model Cont Emission Only 
...
SED_name = 'OverPlot_SEDs_OneOuterShellMod.png'
