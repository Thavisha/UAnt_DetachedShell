...
def OuterShell_plusCont_M2010(dust_file_name, fnu, nu, stellar_luminoisity, stellar_temperature,  stellar_radius, total_shell_mass, uant_distance, present_day_mlr, expansion_velocity,  continuous_envelope_inner_rad, continuous_envelope_outer_rad, Photon_Number, CPU_Number):
	...
	# Write out file
	Input_OuterShell_ContEm_M2010 = 'Model_OuterShell_ContEm_M2010.rtin' #File which saves all the input above so that fortran can run internally for RT modelling
	Output_OuterShell_ContEm_M2010 = 'Model_OuterShell_ContEm_M2010.rtout'
	
	model.write(Input_OuterShell_ContEm_M2010)
	model.run(Output_OuterShell_ContEm_M2010, mpi=True, n_processes=CPU_Number)

	return Input_OuterShell_ContEm_M2010, Output_OuterShell_ContEm_M2010
