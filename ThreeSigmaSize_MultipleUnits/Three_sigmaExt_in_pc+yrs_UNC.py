...
f = open('threeSigma_Radius_Multiple_Units_UNCvalues.csv', 'w')
f.write("source" + "," + "distance" + "," + "Terminal_Velocity_cm/s" + "," + "PACS70_threeSigma_arcsec" + "," + "PACS160_threeSigma_arcsec" + "," + "SCUBA450_threeSigma_arcsec" + "," + "SCUBA850_threeSigma_arcsec" + "," + "PACS70_threeSigma_pc_UNC" + "," + "PACS160_threeSigma_pc_UNC" + "," + "SCUBA450_threeSigma_pc_UNC" + "," + "SCUBA850_threeSigma_pc_UNC" + "," + "PACS70_threeSigma_yrs_UNC" + "," + "PACS160_threeSigma_yrs_UNC" + "," + "SCUBA450_threeSigma_yrs_UNC" + "," + "SCUBA850_threeSigma_yrs_UNC" + "," + "\n")
f.close()

for Source in Source_Data:
	
	star = Source['Source'] 			
	distance = Source['Distance_Unc(pc)'] #units pc
	...
	f = open('threeSigma_Radius_Multiple_Units_UNCvalues.csv', 'a')
