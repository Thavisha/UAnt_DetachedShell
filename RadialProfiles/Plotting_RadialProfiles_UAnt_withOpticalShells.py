...
fig.text(0.95, 0.5,"Residual (mJy arcsec$^{-2}$)", va='center', rotation=-90) #rotation='vertical'


#Plotting 70micron Radial + PSF Profile
ax1 = fig.add_subplot(gs[0,0]) #gs[row, col]
radial_limit_70 = x_70 < 100
ax1.errorbar(x_70[radial_limit_70], stellar_70[radial_limit_70], yerr=stellar_unc_70[radial_limit_70], fmt='o', color='midnightblue', markersize=3, capsize=2, label='70$\\mu m$ Stellar Profile') 
...
ax2.errorbar(x_70[radial_limit_70], res_70[radial_limit_70], yerr=res_unc_70[radial_limit_70], fmt='^', color='orangered', markersize=3, mec='orangered', capsize=2, label='70$\\mu m$ Residual')
plt.axvline(x=25, color='magenta', linestyle='--', label='Shell 1 in Optical') #Adding a vertical line to show shell 1 in optical = 25''
plt.axvline(x=37, color='green', linestyle=':', label='Shell 2 in Optical') #Adding a vertical line to show shell 2 in optical = 37''
plt.axvline(x=43, color='crimson', linestyle='-.', label='Shell 3 in Optical') #Adding a vertical line to show shell 3 in optical = 43''
plt.axvline(x=46, color='darkblue', linestyle='--', label='Shell 4 in Optical') #Adding a vertical line to show shell 4 in optical = 46''
...
radial_limit_160 = x_160 < 100
ax3.errorbar(x_160[radial_limit_160], stellar_160[radial_limit_160], yerr=stellar_unc_160[radial_limit_160], fmt='o', color='midnightblue', markersize=3, capsize=2, label='160$\\mu m$ Stellar Profile') 
...
ax4.errorbar(x_160[radial_limit_160], res_160[radial_limit_160], yerr=res_unc_160[radial_limit_160], fmt='^', color='orangered', mec='orangered',  markersize=3,capsize=2, label='160$\\mu m$ Residual')
plt.axvline(x=25, color='magenta', linestyle='--', label='Shell 1 in Optical') #Adding a vertical line to show shell 1 in optical = 25''
plt.axvline(x=37, color='green', linestyle=':', label='Shell 2 in Optical') #Adding a vertical line to show shell 2 in optical = 37''
plt.axvline(x=43, color='crimson', linestyle='-.', label='Shell 3 in Optical') #Adding a vertical line to show shell 3 in optical = 43''
plt.axvline(x=46, color='darkblue', linestyle='--', label='Shell 4 in Optical') #Adding a vertical line to show shell 4 in optical = 46''
...
radial_limit_450 = x_450 < 60
ax5.errorbar(x_450[radial_limit_450], stellar_450[radial_limit_450], yerr=stellar_unc_450[radial_limit_450], fmt='o', color='midnightblue', markersize=3, capsize=2, label='450$\\mu m$ Stellar Profile') 
...
ax6.errorbar(x_450[radial_limit_450], res_450[radial_limit_450], yerr=res_unc_450[radial_limit_450], fmt='^', color='orangered', mec='orangered', markersize=3, capsize=2, label='450$\\mu m$ Residual')
plt.axvline(x=25, color='magenta', linestyle='--', label='Shell 1 in Optical') #Adding a vertical line to show shell 1 in optical = 25''
plt.axvline(x=37, color='green', linestyle=':', label='Shell 2 in Optical') #Adding a vertical line to show shell 2 in optical = 37''
plt.axvline(x=43, color='crimson', linestyle='-.', label='Shell 3 in Optical') #Adding a vertical line to show shell 3 in optical = 43''
plt.axvline(x=46, color='darkblue', linestyle='--', label='Shell 4 in Optical') #Adding a vertical line to show shell 4 in optical = 46''
...
save_file = star + '_RadialProfile_WithOpticalShells.png'
